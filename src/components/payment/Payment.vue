            ...
            <el-table
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  ...
                  <div v-else>
                    <el-tag  type="success" style="margin-right: 10px">已缴费</el-tag>
                    <el-button
                        type="primary"
                        size="small"
                        slot="reference"
                        @click="showFeedBackDialog(scope.row.caseId)">病情反馈
                    </el-button>
                  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //展示反馈对话框
      showFeedBackDialog(caseId) {
        this.addFeedBackVisible = true
        this.addFeedBack.caseId = caseId
      },
      ...
      addFeedBackHttp() {
        ...
        let jsonData = {}
        jsonData.caseId = this.addFeedBack.caseId
